...
if ( ! function_exists( 'lookshop_woocommerce_cart_link_fragment' ) ) {
	/**
	 * Cart Fragments.
	 *
	 ...
	 */
	function lookshop_woocommerce_cart_link_fragment( $fragments ) {
		ob_start();
		lookshop_woocommerce_cart_link();
		$fragments['a.cart-contents'] = ob_get_clean();

		return $fragments;
	}
}
add_filter( 'woocommerce_add_to_cart_fragments', 'lookshop_woocommerce_cart_link_fragment' );

if ( ! function_exists( 'lookshop_woocommerce_cart_link' ) ) {
	/**
	 * Cart Link.
	 *
	 ...
	 * @return void
	 */
	function lookshop_woocommerce_cart_link() {
		?>
		<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'lookshop' ); ?>">
			<?php
			$item_count_text = sprintf(
				/* translators: number of items in the mini cart. */
				_n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'lookshop' ),
...
if ( ! function_exists( 'lookshop_woocommerce_header_cart' ) ) {
	 ...
	 * @return void
	 */
	function lookshop_woocommerce_header_cart() {
		if ( is_cart() ) {
